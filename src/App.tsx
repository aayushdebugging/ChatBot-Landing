    ...
    const observerCallback = (entries: IntersectionObserverEntry[]) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          // Remove existing active class to allow re-animation
        ...
        <div className="relative py-32 features-bg">
          ...
          <div className="relative max-w-6xl mx-auto px-4">
            <div className="text-center mb-16 scroll-reveal">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">Discover the next generation of 3D printing capabilities with our cutting-edge features designed for professionals and enthusiasts alike.</p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: Printer, title: 'Multi-Material Printing', desc: 'Print with multiple materials simultaneously for complex, functional parts.' },
                { icon: Settings, title: 'Advanced Calibration', desc: 'Auto-calibration system ensures perfect bed leveling and print quality.' },
                { icon: Zap, title: 'Real-time Monitoring', desc: 'Monitor your prints remotely with live HD camera feed and status updates.' },
                { icon: Users, title: 'Community Hub', desc: 'Join our thriving community to share designs and get inspired.' },
                { icon: Layers, title: 'Layer Analysis', desc: 'AI-powered layer analysis for optimal print quality and error detection.' },
                { icon: Cpu, title: 'Smart Workflow', desc: 'Streamlined workflow with intelligent print queue management.' }
              ].map(({ icon: Icon, title, desc }, i) => (
                <div 
                  key={i}
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="glass-effect p-8 rounded-2xl border border-white/10 scroll-reveal">
                ...
                <p className="text-gray-400 mb-8">Have questions about our 3D printing solutions? We're here to help you bring your ideas to life.</p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@printmaster.com" className="text-purple-400 hover:text-purple-300 transition-colors">contact@printmaster.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+1234567890" className="text-purple-400 hover:text-purple-300 transition-colors">+1 (234) 567-890</a>
                    </div>
                  </div>
              ...
              <div className="glass-effect p-8 rounded-2xl border border-white/10 scroll-reveal" style={{ transitionDelay: '0.2s' }}>
                <form className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-white font-light mb-2">Name</label>
                    <input
                      type="text"
                      id="name"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-white font-light mb-2">Email</label>
                    <input
                      type="email"
                      id="email"
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-purple-500/20"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-white font-light mb-2">Message</label>
                    <textarea
                      id="message"
                      rows={4}
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-purple-500/20"
          ...
          <div className="max-w-6xl mx-auto px-4 relative z-10">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="scroll-reveal">
                ...
                <p className="text-gray-400 font-light">Revolutionizing the future of manufacturing through advanced 3D printing technology.</p>
              </div>
              
              <div className="scroll-reveal" style={{ transitionDelay: '0.2s' }}>
                <h4 className="text-white font-light text-lg mb-4">Products</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">3D Printers</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Materials</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Software</a></li>
            ...
            <div className="mt-12 pt-8 border-t border-white/10 text-center scroll-reveal">
              <p className="text-gray-400 font-light">&copy; {new Date().getFullYear()} PrintMaster. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
